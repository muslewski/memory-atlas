...
export const DEFAULT_CHECK = {
  ...
  ownership: true,
  /**
   * Fail `atlas check` when the committed map/index.md differs from a fresh
   * render. Set false in repos where many agents recollect in parallel and one
   * integrator rebuilds the index.
   */
  indexSync: true,
