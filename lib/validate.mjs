 ...
 * @param {Resolvers} r
 * @param {{ noteIds?: Set<string>, pillars?: Array<Record<string, unknown>>, decisions?: Array<Record<string, unknown>>, check?: { ownership?: boolean, strictFreshness?: boolean, corpus?: Record<string, unknown> } }} [graph]
