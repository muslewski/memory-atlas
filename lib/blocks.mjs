 ...
 * @param {{ vaultName: string }} opts
 * @returns {string}
 */
export function renderOnrampBlock(kind, { vaultName }) {
  const body = kind === 'agents' ? agentsBody(vaultName) : claudeBody(vaultName)
  return `${BLOCK_BEGIN}\n${body}\n${BLOCK_END}`
}
